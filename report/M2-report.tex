...
The graph plots the average score over each block of $1000$ training episodes, rising from roughly $8{,}400$ after the first $1000$ episodes to about $24{,}400$ at $10{,}000$. The code excerpt shows the TD$(0)$ update: the target for an afterstate is the reward of the following move plus the estimated value of the next afterstate, and the network is corrected by that error scaled by the learning rate.
